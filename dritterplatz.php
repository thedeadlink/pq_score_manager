...
$thirdTeam = isset($teams[2]) ? $teams[2] : null;
$thirdScore = $thirdTeam !== null ? $teamTotals[$thirdTeam] : null;
...
<body>
    <div class="centerbox">
        <div class="label">3. Platz</div>
        <?php if ($thirdTeam !== null): ?>
            <div class="teamname"><?php echo htmlspecialchars($thirdTeam, ENT_QUOTES | ENT_HTML5, 'UTF-8'); ?></div>
            <div class="score">Punkte: <?php echo $thirdScore; ?></div>
        <?php else: ?>
