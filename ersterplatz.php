...
$firstTeam = isset($teams[0]) ? $teams[0] : null;
$firstScore = $firstTeam !== null ? $teamTotals[$firstTeam] : null;
...
<body>
    <div class="centerbox">
        <div class="label">1. Platz</div>
        <?php if ($firstTeam !== null): ?>
            <div class="teamname"><?php echo htmlspecialchars($firstTeam, ENT_QUOTES | ENT_HTML5, 'UTF-8'); ?></div>
            <div class="score">Punkte: <?php echo $firstScore; ?></div>
        <?php else: ?>
